...
searchContainer.innerHTML = `
  ...
  style="padding:8px 12px; border-radius:8px; width:70%; max-width:300px; border:none; outline:none; background:var(--input-bg); color:var(--text-color); text-align:center;">
`;

const poinSection = document.getElementById("poin");
if (poinSection) poinSection.insertAdjacentElement("afterend", searchContainer);
...
function tampilkanDataSeason() {
  ...
  // 🎨 Warna adaptif untuk info range
  infoRange.innerHTML = `
